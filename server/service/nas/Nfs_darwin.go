...
// GetExportOptions macOS版本存根
func (n *NfsShare) GetExportOptions() string {
	return "unsupported_on_macos"
}

// GetExportLine macOS版本存根
func (n *NfsShare) GetExportLine() string {
	return "# NFS not supported on macOS"
}

// NfsService macOS版本的NFS服务管理存根
